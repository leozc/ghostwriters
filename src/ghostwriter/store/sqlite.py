...
class Store:
    ...
    def __init__(self, db_path: Path, content_root: Path | None = None):
    ...
    def latest_version(self, article_id: str) -> dict | None:
    ...
    def lookup_idempotency(self, task_id: str, key: str) -> str | None:
        cur = self._conn.cursor()
        row = cur.execute(
    ...
    def record_iteration(
        ...
        *,
        ...
        consume_note_ids: list[str] | None = None,
    ...
    def get_fact_check(self, task_id: str) -> FactCheckReport | None:
        cur = self._conn.cursor()
        row = cur.execute(
    ...
    def get_rejected(self, rejected_id: str) -> dict | None:
        cur = self._conn.cursor()
        row = cur.execute(
